...
namespace Aqua_Project.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public CompaniesController(WorkContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CompanyId,CompanyName,Number,Branch,Email")] Companies companies)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CompanyId,CompanyName,Number,Branch,Email")] Companies companies)
        {
